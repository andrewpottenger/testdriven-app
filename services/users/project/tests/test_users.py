...
class TestUserService(BaseTestCase):
    ...
    def test_single_user(self):
        ...
        user = add_user('michael', 'michael@realpython.com', 'testpassword')
        with self.client:
    ...
    def test_all_users(self):
        ...
        add_user('michael', 'michael@realpython.com', 'testpassword')
        add_user('fletcher', 'fletcher@realpython.com', 'testpassword')
        with self.client:
    ...
    def test_add_user_inactive(self):
        """
        Ensure error is thrown if the user
        does not provide a valid token and is
        inactive.
        """
        add_user('test', 'test@test.com', 'test')
